			...
			<div class="menu-block customscroll">
				<div class="sidebar-menu">
					<ul id="accordion-menu">
						<li>
						<a href="index.php?code=<?php echo isset($_GET["code"])? $_GET["code"]:""; ?>" class="dropdown-toggle no-arrow">
						...
						<li >
							<a href="movimiento.php?code=<?php echo isset($_GET["code"])? $_GET["code"]:"";  ?>" class="dropdown-toggle no-arrow">
						...
						<li >
							<a href="caja.php?code=<?php echo isset($_GET["code"])? $_GET["code"]:"";  ?>" class="dropdown-toggle no-arrow">
		...
		<div class="main-container">
			<div class="xs-pd-20-10 pd-ltr-20">
				<div class="title pb-20">
					<h2 class="h3 mb-0">Saldo de cajas</h2>
				</div>
